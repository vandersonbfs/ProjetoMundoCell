...
Else
    ...
    Email.Subject = "Ordem de Servi�o N� " & os & " - " & emp
...
cbbServi�o.Value = ListBox1.List(nlin, 7)
...
'Finaliza��o    H4 - Criar evento de finaliza��o de OS
...
Label61.Caption = Planilha5.Range("L6").Value
    ...
    UserForm1.cbbServi�o.Clear
    totLIN = Planilha2.Range("g" & Rows.Count).End(xlUp).Row
    
        For LIN = 1 To totLIN
            UserForm1.cbbServi�o.AddItem Planilha2.Cells(LIN, 7)
        Next LIN
